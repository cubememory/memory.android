...
public class CHttpFilePostTask extends CHttpTask{
	private File localFile;

	public CHttpFilePostTask(String remotePath, String localFile, int maxRetryCount, CHttpHandler handler) throws CHttpException{
	...
	protected void request() throws CHttpException{
		...
		try{
			...
			start.append("Content-Disposition: form-data; name=\"file\"; filename=\""+this.localFile.getName()+"\"\r\n");
			...
			long contentLength =  this.localFile.length()+startb.length+endb.length;
