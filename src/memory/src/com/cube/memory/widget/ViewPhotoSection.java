...
public class ViewPhotoSection extends RelativeLayout implements OnClickListener{
	private TextView mTextViewDate;
	private TextView mTextViewTotal;
	private TextView mTextViewMore;
	private GridView mGridViewImages;
	
	public ViewPhotoSection(Context context) {
		super(context);
		init(context);
	}

	public ViewPhotoSection(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	
	public ViewPhotoSection(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setData(EntityAlbum<EntityPhoto> album){
	...
	private static class AdapterGridView extends BaseAdapter{
		...
		private List<EntityPhoto> mItems = new ArrayList<EntityPhoto>();
		
		public AdapterGridView(Context context, List<EntityPhoto> items){
		...
		private static class DisplayTask implements Runnable{
			...
			@Override
			public void run() {
				Bitmap bitmap = MediaStore.Images.Thumbnails.getThumbnail(mResolver, mImageID, MediaStore.Images.Thumbnails.MICRO_KIND, null);
