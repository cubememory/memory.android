 ...
 * @author Jeff Gilfelt
 */
public class ViewBadge extends TextView {
	...
	public ViewBadge(Context context) {
		this(context, (AttributeSet) null, android.R.attr.textViewStyle);
	}

	public ViewBadge(Context context, AttributeSet attrs) {
	 ...
	 */
	public ViewBadge(Context context, View target) {
	 ...
	 */
	public ViewBadge(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}

	public ViewBadge(Context context, AttributeSet attrs, int defStyle) {
